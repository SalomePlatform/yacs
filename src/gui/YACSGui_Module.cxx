...
{
  MESSAGE("YACSGui_Module::onStartResume()");
  YACSGui_Executor* anExecutor = findExecutor();
  if (anExecutor)
...
{
  MESSAGE("YACSGui_Module::onWithoutStopMode()");
  YACSGui_Executor* anExecutor = findExecutor();
...
{
  MESSAGE("YACSGui_Module::onBreakpointsMode()");
  YACSGui_Executor* anExecutor = findExecutor();
...
{
  MESSAGE("YACSGui_Module::onStepByStepMode()");
  YACSGui_Executor* anExecutor = findExecutor();
